...
import { AbFindManyArgs } from "../../ab/base/AbFindManyArgs";
import { Ab } from "../../ab/base/Ab";
...
export class AddressControllerBase {
  ...
  async findManyCustomers(
    ...
    const query = plainToClass(AbFindManyArgs, request.query);
  ...
  async connectCustomers(
    @common.Param() params: AddressWhereUniqueInput,
    @common.Body() body: AbWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      customers: {
        connect: body,
